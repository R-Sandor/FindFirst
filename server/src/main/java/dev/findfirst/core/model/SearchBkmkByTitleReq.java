...
@Override public boolean equals(Object obj){if(obj instanceof SearchBkmkByTitleReq(String[]keywords)){return Arrays.equals(this.keywords(),keywords);}return false;}

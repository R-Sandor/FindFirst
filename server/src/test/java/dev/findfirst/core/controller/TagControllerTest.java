  ...
  void addTags() {
    ...
    var tagResp =
        restTemplate.exchange(
            "/api/tags", HttpMethod.POST, getHttpEntity(restTemplate, tagsToAddList), Tag[].class);
  ...
  void deleteAllTags() {
    ...
    var bkmksOpts =
        Optional.ofNullable(
            restTemplate
                .exchange(
                    "/api/bookmarks", HttpMethod.GET, getHttpEntity(restTemplate), Bookmark[].class)
                .getBody());
